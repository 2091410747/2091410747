...
#if !defined(_WIN32) && defined(USE_STDIO_MACRO)
...
#elif defined(_WIN32) && _MSC_VER == 1600
...
#define LIBAV_CONFIGURATION "--enable-shared --disable-static --enable-memalign-hack"
#define LIBAV_LICENSE "LGPL version 2.1 or later"
#define AVCONV_DATADIR "/usr/local/share/avconv"
#define CC_IDENT "gcc 4.7.1 (GCC)"
