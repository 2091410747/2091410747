...
{
public:
	virtual void setEndColors(bool bEnable, const video::SColor& colorMin, const video::SColor& colorMax) = 0;
	virtual void setFadeInTime(u32 fadeInTime) = 0;
	virtual u32 getFadeInTime() const = 0;
