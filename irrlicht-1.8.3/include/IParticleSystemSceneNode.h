...
public:
	...
	IParticleSystemSceneNode(ISceneNode* parent, ISceneManager* mgr, s32 id,
		...
		const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f))
			: ISceneNode(parent, mgr, id, position, rotation, scale), maxParticlesCountVisible(16250) {}
	...
	virtual void doParticleSystem(u32 time, u32 lastEmitTime) = 0;
	virtual u32 getLastEmitTime() = 0;
	virtual void setCurrentParticlesOffset(f32 fdx, f32 fdy) = 0;

	virtual u32 getCurrentParticlesCount() = 0;
	...
	virtual void setMaxParticlesCountVisible(s32 maxCount)
	{
		maxParticlesCountVisible = maxCount;
	}
protected:
		s32 maxParticlesCountVisible;
};
