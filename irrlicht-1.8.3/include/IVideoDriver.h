...
namespace video
{
	...
	*/
	...
	{
	public:
		virtual bool activeTexture2D(const video::ITexture* pTexture){return false;}
		virtual void setRenderStates2D(bool alpha, bool texture, bool alphaChannel){}
		virtual void setVertexShader2D(video::E_VERTEX_TYPE newType){}
		virtual void* getD3D9Device() const = 0;
		virtual void setUseForConversion(bool bForConversion) = 0;
		virtual bool setActiveTexture(u32 stage, const video::ITexture* texture){return false;}
